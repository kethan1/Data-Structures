...
myList1.pop(0)
print(f"Popped the element from index 1: {myList1}")
del myList1[0]
print(f"Deleted image in position 0 with del keyword: {myList1}")
print(f"Get element in position 1: {myList1[0]}")
